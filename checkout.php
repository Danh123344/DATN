...
<body>
    ...
    <?php
    // Header (ở đây thường đã có session_start rồi)
    include("./templates/header.php");

    // Kết nối DB
    include "./service/config.php";

    // Bắt buộc phải có giỏ hàng
    if (!isset($_SESSION['cart']) || empty($_SESSION['cart'])) {
        echo '<div class="container py-5"><h3 class="text-center">Bạn chưa có sản phẩm nào trong giỏ hàng.</h3></div>';
    ...
    // Lấy thông tin khách hàng + trạng thái tài khoản
    $sqlUser = "SELECT id, HoTen, DienThoai, TinhTrang FROM KhachHang WHERE TenDangNhap = '$username' LIMIT 1";
    $resultUser = mysqli_query($conn, $sqlUser);
    $user = mysqli_fetch_assoc($resultUser);

    if (!$user) {
        echo '<div class="container py-5"><h3 class="text-center text-danger">Không tìm thấy thông tin tài khoản.</h3></div>';
        include("./templates/footer.php");
        exit;
    }

    // Nếu tài khoản đang bị khóa (TinhTrang = 0) thì không cho đặt hàng
    if ((int)$user['TinhTrang'] === 0) {
        echo '<div class="container py-5"><h3 class="text-center text-danger">Tài khoản của bạn đang bị khóa, không thể đặt hàng. Vui lòng liên hệ quản trị viên.</h3></div>';
        include("./templates/footer.php");
        exit;
    }

    // Nếu mọi thứ ok → tiếp tục xử lý checkout
    $cart = $_SESSION['cart'];
    $sub_total = 0;
        ...
        <div class="container">
            <form>
                ...
                <div class="md-form row mt-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control text-dark" id="fullname"
                ...
                <div class="md-form row mt-2">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control text-dark" id="phonenumber"
                               placeholder="vd: 077668235"
                ...
                <div class="md-form row mt-2">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control text-dark" id="address" rows="3"
                                  placeholder="vd: 123 Cao Lỗ, Phường 4, Quận 8"></textarea>
